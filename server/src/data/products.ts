...
export const PRODUCTS: Product[] = [
  // ---------------- Wedding Gowns ----------------
  p('wedding-gowns', 'pearl-beaded-fish-gown', 'Fish Gown', 400000, 650000, 30,
  ...
  p('wedding-gowns', 'illusion-sleeve-ball-gown', 'Ball Gown', 450000, 750000, 30,
  ...
  p('wedding-gowns', 'beaded-satin-ball-gown', 'Ball Gown', 380000, 600000, 28,
    'A clean satin ball gown with a fully beaded long-sleeve bodice.',
    { images: slides('beaded-satin-ball-gown', 2), sizes: DRESS_SIZES }),
  p('wedding-gowns', 'off-shoulder-corset-ball-gown', 'Ball Gown', 380000, 620000, 28,
  ...
  p('wedding-gowns', 'halter-beaded-fish-gown', 'Fish Gown', 350000, 550000, 26,
  ...
  p('wedding-gowns', 'lace-a-line-gown', 'A-Line Gown', 250000, 450000, 24,
  ...
  p('wedding-gowns', 'one-shoulder-ruffle-fish-gown', 'Fish Gown', 380000, 600000, 28,
  ...
  p('wedding-gowns', 'strapless-satin-ball-gown', 'Ball Gown', 300000, 500000, 24,
  ...
  // ---------------- Bridesmaid Dresses ----------------
  p('bridesmaid-dresses', 'satin-corset-slit-bridesmaid-gown', 'Bridesmaid Dress', 65000, 120000, 14,
  ...
  p('bridesmaid-dresses', 'one-shoulder-bow-mermaid-bridesmaid-gown', 'Bridesmaid Dress', 60000, 110000, 14,
    'A sleek mermaid gown with an oversized one-shoulder bow, pictured in emerald.',
    { sizes: DRESS_SIZES, colors: BRIDESMAID_COLORS }),
  p('bridesmaid-dresses', 'off-shoulder-lace-corset-mermaid-bridesmaid-gown', 'Bridesmaid Dress', 70000, 125000, 14,
    'An off-shoulder mermaid with a sheer lace corset panel, pictured in burnt orange.',
    { sizes: DRESS_SIZES, colors: BRIDESMAID_COLORS, featured: true }),
  p('bridesmaid-dresses', 'v-neck-satin-mermaid-bridesmaid-gown', 'Bridesmaid Dress', 55000, 100000, 12,
    'A classic V-neck satin mermaid that flatters every body on the train, pictured in berry.',
    { sizes: DRESS_SIZES, colors: BRIDESMAID_COLORS }),
  p('bridesmaid-dresses', 'off-shoulder-bow-back-bridesmaid-gown', 'Bridesmaid Dress', 65000, 115000, 14,
    'An off-shoulder gown with a statement bow and floor-length sash at the back, pictured in dusty pink.',
    { sizes: DRESS_SIZES, colors: BRIDESMAID_COLORS }),

  // ---------------- Bridal Shower Robes ----------------
  p('bridal-shower-robes', 'bride-tulle-robe-and-satin-bridesmaid-robes', 'Bridal Robe Set', 20000, 90000, 10,
  ...
  p('bridal-shower-robes', 'feathered-tulle-bridal-party-robes', 'Tulle Bridal Party Robes', 25000, 60000, 10,
    'Sheer tulle robes trimmed with fluffy feathers for photos that pop, pictured in sky blue.',
    { sizes: DRESS_SIZES, colors: ROBE_COLORS }),

  // ---------------- Flower Girl Dresses ----------------
  p('flower-girl-dresses', 'tulle-ball-gown-flower-girl-dress', 'Flower Girl Dress', 35000, 75000, 12,
  ...
  p('wedding-veils', 'fingertip-lace-edge-veil', 'Fingertip Veil', 20000, 45000, 8,
    'A single-tier fingertip veil with a scalloped lace edge.',
    { colors: [WHITE, IVORY, OFF_WHITE] }),

  // ---------------- Wedding Fascinators ----------------
  p('wedding-fascinators', 'crinoline-flower-fascinator-and-lace-gloves-set', 'Fascinator & Gloves Set', 30000, 70000, 10,
    'A sheer crinoline flower headpiece with matching pearl-trimmed lace gloves.',
    { colors: [WHITE, IVORY, BLUSH] }),
  p('wedding-fascinators', 'sequin-pillbox-bridal-hat', 'Pillbox Hat', 25000, 60000, 10,
    'A sequinned pillbox hat with crinoline swirls and crystal flowers.',
    { colors: [WHITE, IVORY, SILVER, GOLD], featured: true }),
  p('wedding-fascinators', 'feathered-saucer-fascinator-hat', 'Saucer Hat', 35000, 80000, 10,
    'A wide saucer hat finished with sweeping feathers, for brides, mums and wedding guests.',
    { colors: [IVORY, CHAMPAGNE, GOLD] }),
  p('wedding-fascinators', 'sculptural-couture-fascinator', 'Couture Fascinator', 35000, 85000, 12,
    'A sculptural looped headpiece that makes a statement from every angle.',
    { colors: [IVORY, WHITE, GOLD] }),

  // ---------------- Wedding Hair Pins ----------------
  p('wedding-hair-pins', 'chiffon-flower-hair-comb-and-pin-set', 'Hair Comb & Pin Set', 10000, 25000, 5,
    'A three-piece set of chiffon flowers with pearl sprays: one comb, two pins.',
    { colors: [WHITE, IVORY, BLUSH] }),
  p('wedding-hair-pins', 'pearl-and-crystal-floral-hair-comb', 'Floral Hair Comb', 12000, 30000, 5,
    'A gold-wired comb of silk flowers, freshwater pearls and crystals.',
    { colors: [WHITE, IVORY, GOLD], featured: true }),
  p('wedding-hair-pins', 'white-rose-hair-pins-set', 'Floral Hair Pins', 8000, 20000, 4,
    'Silk white roses with gold accents on hair pins, sold as a set.',
    { colors: [WHITE, IVORY, BLUSH] }),
  p('wedding-hair-pins', 'pearl-cluster-hair-pins-set', 'Pearl Hair Pins', 8000, 20000, 4,
    'Gold U-pins topped with clusters of pearls, sold as a set.',
    { colors: [WHITE, IVORY, GOLD] }),

  // ---------------- Wedding Hand Fans ----------------
  p('wedding-fans', 'personalized-white-feather-bridal-fan', 'Personalized Feather Fan', 25000, 50000, 7,
  ...
  p('wedding-fans', 'personalized-aso-oke-traditional-fan', 'Personalized Aso-Oke Fan', 20000, 45000, 7,
  ...
  p('wedding-fans', 'bride-feather-folding-fan', 'Bride Folding Fan', 20000, 40000, 6,
  ...
  p('wedding-fans', 'flower-shaped-traditional-hand-fan', 'Traditional Hand Fan', 15000, 35000, 6,
  ...
  p('wedding-fans', 'feather-folding-fans-bridesmaid-set', 'Bridesmaid Folding Fans', 15000, 30000, 6,
    'Soft feather folding fans for the bridesmaids, priced per fan.',
    { colors: [WHITE, IVORY, BLUSH, BURNT_ORANGE] }),
  p('wedding-fans', 'gold-trim-feather-bridal-fan', 'Feather Bridal Fan', 25000, 50000, 7,
  ...
  // ---------------- Wedding Purses ----------------
  p('wedding-purses', 'crystal-beaded-pearl-handle-bridal-bag', 'Beaded Bridal Bag', 30000, 70000, 10,
    'A hand-beaded crystal bag with a woven pearl handle.',
    { colors: [WHITE, IVORY, CHAMPAGNE, GOLD], featured: true }),
  p('wedding-purses', 'floral-pomander-bridal-purse', 'Pomander Purse', 25000, 55000, 7,
    'A pomander of silk blooms on a pearl wristlet, a bag and bouquet in one.',
    { colors: FLORAL_COLORS }),
  p('wedding-purses', 'pearl-beaded-ring-handle-purse', 'Pearl Purse', 30000, 65000, 10,
    'A fully pearl-beaded purse with gold ring handles and a satin lining.',
    { colors: [WHITE, IVORY, CHAMPAGNE] }),

  // ---------------- Petticoats & Hoop Skirts ----------------
  p('bridal-petticoats', 'five-tier-ruffle-petticoat', 'Ruffle Petticoat', 20000, 45000, 7,
    'Five tiers of ruffled tulle for a full, soft ball gown shape.',
    { sizes: PETTICOAT_SIZES, colors: [WHITE, IVORY], featured: true }),
  p('bridal-petticoats', 'short-tulle-petticoat', 'Short Petticoat', 12000, 25000, 5,
    'A knee-length tulle petticoat for short and tea-length dresses.',
    { sizes: PETTICOAT_SIZES, colors: [WHITE, IVORY] }),
  p('bridal-petticoats', 'ruffled-hoop-petticoat', 'Hoop Petticoat', 22000, 48000, 7,
    'Boned hoops under layers of ruffles for maximum volume without the weight.',
    { sizes: PETTICOAT_SIZES, colors: [WHITE, IVORY] }),
  p('bridal-petticoats', 'tea-length-a-line-petticoat', 'A-Line Petticoat', 15000, 30000, 5,
    'A soft A-line petticoat that adds gentle body under midi and tea-length skirts.',
    { sizes: PETTICOAT_SIZES, colors: [WHITE, IVORY] }),
  p('bridal-petticoats', 'six-hoop-ball-gown-petticoat', 'Ball Gown Hoop Skirt', 20000, 45000, 6,
    'A six-hoop crinoline for the fullest ball gowns.',
    { sizes: PETTICOAT_SIZES, colors: [WHITE, IVORY] }),
  p('bridal-petticoats', 'fish-gown-train-petticoat', 'Fish Gown Petticoat', 18000, 40000, 6,
    'A fitted petticoat that flares at the knee to support fish gowns and trains.',
    { sizes: PETTICOAT_SIZES, colors: [WHITE, IVORY] }),
  p('bridal-petticoats', 'layered-tulle-full-petticoat', 'Tulle Petticoat', 20000, 45000, 7,
    'Layers of stiff tulle for a full, hoop-free skirt shape.',
    { sizes: PETTICOAT_SIZES, colors: [WHITE, IVORY] }),
  p('bridal-petticoats', 'three-hoop-petticoat', 'Hoop Skirt', 15000, 35000, 5,
